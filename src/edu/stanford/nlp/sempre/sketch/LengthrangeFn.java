...
public class LengthrangeFn extends SemanticFn {
    ...
    public LengthrangeFn() { }

    public void init(LispTree tree) {
        super.init(tree);
        this.type1 = tree.child(1).child(0).value;
        this.value1 = Integer.valueOf(tree.child(1).child(1).value);
        this.type2 = tree.child(2).child(0).value;
        this.value2 = Integer.valueOf(tree.child(2  ).child(1).value);
    }
            ...
            public Derivation createDerivation() {
                ...
                if (targetCat.equals("$SKETCH") || targetCat.equals("$PROGRAM")) {
                    ...
                    if (Integer.parseInt(arg1) >= Integer.parseInt(arg2))
                        return null;
                    formula = new NameValue("repeatrange(<any>," + arg1 + "," + arg2 + ")");
                } else {
