...
java -Xmx2g -cp libregex/*:libsempre/*:lib/* -ea regex.Test -languageAnalyzer corenlp.CoreNLPAnalyzer -Grammar.inPaths regex/regex1.grammar -SimpleLexicon.inPaths regex/regex1.lexicon -Parser.beamSize $beam $dataset
